        ...
        <table class="form-table" role="presentation">
            <tbody>
                    ...
                    <td>
                        ...
                        foreach($shops as $shop){
                            ...
                            <option value="<?php echo $shop->id ?>"
                                <?php
                                    if(isset($post) && ($post->shop_id == $shop->id))
                                        echo 'selected';                                    
                                ?>
                ...
                <tr class="form-field form-required">
                    ...
                    <td><input name="regular" type="number" id="regular" min="0" aria-required="true" required autocapitalize="none" autocorrect="off" maxlength="60" value="<?php echo isset($post) ? ($post->regular == 0 ? '' : ($post->regular == '' ? '' : $post->regular)) : '' ?>"></td>
                </tr>
                <tr class="form-field form-required">
                    <th scope="row"><label for="user_login">セール価格</label></th>
                    <td><input name="sale" type="number" id="sale" min="0" aria-required="true" required autocapitalize="none" autocorrect="off" maxlength="60" value="<?php echo isset($post) ? ($post->sale == 0 ? '' : ($post->sale == '' ? '' : $post->sale)) : '' ?>"></td>
                </tr>
