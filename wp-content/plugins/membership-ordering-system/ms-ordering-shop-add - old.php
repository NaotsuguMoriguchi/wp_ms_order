...
if($_REQUEST['action'] == 'createuser'){
	...
	$data = array('shop_name' => isset($_REQUEST['shop_name']) ? $_REQUEST['shop_name'] : '', 
...
if(isset($_REQUEST['i']) && !empty($_REQUEST['i'])){
    $posts = $wpdb->get_results("SELECT * FROM wp_ms_shop where id = ".intval($_REQUEST['i']));
    $post =$posts[0];
}
?>
<style type="text/css">
		...
		<table class="form-table" role="presentation">
			<tbody>
				<tr class="form-field form-required">					
					...
					<td><input name="shop_name" type="text" id="shop_name" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" value="<?php echo isset($post) ? $post->shop_name : '' ?>"></td>
				</tr>
				<tr class="form-field form-required">
					<th scope="row"><label for="user_login">住所</label></th>
					<td><input name="shop_address" type="text" id="shop_address" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="100" value="<?php echo isset($post) ? $post->shop_address : '' ?>"></td>
				</tr>
				<tr class="form-field form-required">
				...
				<tr class="form-field form-required">
					<th scope="row"><label for="user_login">請求書、納品書発送先情報</label></th>
					<td><input name="invoice_info" type="text" id="invoice_info" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="600" value="<?php echo isset($post) ? $post->invoice_info : '' ?>"></td>
				</tr>
			</tbody>
		</table>
