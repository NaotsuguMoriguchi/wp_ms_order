...
class Fashion_Estore_Loader {
	 ...
	 * @return void
	 */
	public function fashion_estore_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function fashion_estore_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function fashion_estore_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function fashion_estore_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->fashion_estore_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function fashion_estore_load( $class ) {
