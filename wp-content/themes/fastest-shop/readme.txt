...
Donate link:  https://athemeart.com/downloads/fastest-shop/
...
== Upgrade Notice  ==
= 1.0.6 =
* Fixed Undefined variable class-post-related.php  

= 1.0.5 =
* add css for active current-menu-item 
* add header icon inside a hook
