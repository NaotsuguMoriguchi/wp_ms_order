	...
	function site_loop_navigation( $type = '' ) {
		...
		if( $type == 'default' ):
			...
			the_posts_navigation(
				array(
					'prev_text' => '<span>'.esc_html__('Previous Posts', 'fastest-shop').'<i class="icofont-rounded-double-right"></i></span>',
					'next_text' => '<span><i class="icofont-rounded-double-left"></i>'.esc_html__('Next Posts', 'fastest-shop').'</span>',
